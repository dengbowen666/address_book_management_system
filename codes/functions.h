...
void search1(const vector<Contact>& contacts, int T = 0) {
    ...
    l1:		cout << "1、（当前结果基础上）继续" << endl << "2、返回主界面" << endl;
        char m;
        cin >> m;
        for (;;) {
            if (m == '1') {
...
void search2(const vector<Contact>& contacts, int T = 0) {
    ...
    for (int i = 0; i < contacts.size(); i++)
    {
        int len1 = phoneNumber0.size();
        int len2 = contacts[i].phoneNumber.size();
        if (len1 <= len2) {
    ...
    l2:		cout << "1、（当前结果基础上）继续" << endl << "2、返回主界面" << endl;
        char m;
        cin >> m;
        for (;;) {
            if (m == '1') {
...
void search3(const vector<Contact>& contacts, int T) {
    ...
    l3:		cout << "1、（当前结果基础上）继续" << endl << "2、返回主界面" << endl;
        char m;
        cin >> m;
        for (;;) {
            if (m == '1') {
...
void search4(const vector<Contact>& contacts, int T = 0) {
    ...
    for (int i = 0; i < contacts.size(); i++)
    {
        int len1 = address0.size();
        int len2 = contacts[i].address.size();
        if (len1 <= len2) {
    ...
    l4:		cout << "1、（当前结果基础上）继续" << endl << "2、返回主界面" << endl;
        char m;
        cin >> m;
        for (;;) {
            if (m == '1') {
...
void search5(const vector<Contact>& contacts, int T = 0) {
    ...
    for (int i = 0; i < contacts.size(); i++)
    {
        int len1 = birthdate0.size();
        int len2 = contacts[i].birthdate.size();
        if (len1 <= len2) {
    ...
    l5:		cout << "1、（当前结果基础上）继续" << endl << "2、返回主界面" << endl;
        char m;
        cin >> m;
        for (;;) {
            if (m == '1') {
