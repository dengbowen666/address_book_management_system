...
void search1(const vector<Contact>& contacts, int T ) {
    int t = T;
    string name0;
    int num = 0;
    //clearIstream();
...
void search2(const vector<Contact>& contacts, int T ) {
    int t = T;
    cout << "请输入电话：";
    string phoneNumber0;
    int num = 0;
...
void search4(const vector<Contact>& contacts, int T ) {
    int t = T;
    cout << "请输入地址：";
    string address0;
    int num = 0;
...
void search5(const vector<Contact>& contacts, int T ) {
    int t = T;
    cout << "请输入生日：";
    string birthdate0;
    int num = 0;
